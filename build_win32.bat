...
@set LIBS=/LIBPATH:"%DXSDK_DIR%/Lib/x86"
mkdir %OUT_DIR%
cl /std:c++20 /Zc:strictStrings- /Fd%OUT_DIR%/ /Zi /DEBUG /fsanitize=address /guard:cf /GS /Od /MD /EHacr /utf-8 %INCLUDES% /D UNICODE /D _UNICODE %SOURCES% /Fe%OUT_DIR%/%OUT_EXE%.exe /Fo%OUT_DIR%/ /link %LIBS%
